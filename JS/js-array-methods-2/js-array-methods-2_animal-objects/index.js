...
const animalsSortedByWeightReversed = animalsSortedByWeightStartingWithLowest.reverse();
console.log(animalsSortedByWeightReversed);

const animalWithWeightMoreThanFivehundredExists = animals.filter((animal) => animal.weight > 500);
console.log(animalWithWeightMoreThanFivehundredExists);

// Hint: Filter for Europe first, then check every animal for its weight.
const allAnimalsInEuropeWeighLessThanOnehundred = animals.filter((animal) => animal.continents === "Europe");

allAnimalsInEuropeWeighLessThanOnehundred.find((animal) => animal.weight < 100);
